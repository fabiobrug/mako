...
- **Monorepo architecture**: Restructured project with `apps/cli/` for CLI and `apps/landing/` for landing page
- **New landing page**: Modern Next.js landing page with Tailwind CSS
...
**Current Version**: v1.2.0 (2026-02-12) - **Monorepo Structure & Landing Page**
